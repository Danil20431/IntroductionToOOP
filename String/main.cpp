...
void main()
{
	...
	str3.print();
	String str4();    // Здесь не вызывается никакой конструктор, т.к. здесь не создаётся объект, а объявляется функция str4() которая ничего не принимает и возвращает значение типа String
	//str4.print();
	String str5{};
	str5.print();

	String str6("World");    //Single-argument constructor
